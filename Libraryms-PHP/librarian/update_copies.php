...
<html>
	...
	<body>
		<form class="cd-form" method="POST" action="#">
			<center><legend>Cập nhật bản sao sách</legend></center>
				...
				<div class="icon">
					<input class="b-copies" type="number" name="b_copies" placeholder="Bản sao để thêm" required />
				</div>
						
				<input type="submit" name="b_add" value="Cập nhật" />
		</form>
	</body>
	...
	<?php
		if(isset($_POST['b_add']))
		{
			...
			if(mysqli_num_rows($query->get_result()) != 1)
				echo error_with_field("ISBN không hợp lệ", "b_isbn");
			else
			{
				...
				echo success("Số bản sách đã được cập nhật");
			}
		}
	?>
</html>